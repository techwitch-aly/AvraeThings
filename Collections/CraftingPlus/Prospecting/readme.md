...
Similar to mining, you can make three attempts at prospecting. If you successfully prospect some geodes, you can make another prospecting check on the same day to find a new one (max of three assuming you successfully mine each geode cluster) or you can make three attempts to mine the same geode cluster if it proves particularly difficult to get the geodes out of the cluster.